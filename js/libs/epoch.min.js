...
(function() {
    Epoch.TestContext = function() {
        function e() {
            ...
            this._log = [];
            a = 0;
            for (d = g.length; a < d; a++) c = g[a], this._makeFauxMethod(c)
        }
        var g;
        ...
        e.prototype._makeFauxMethod = function(c) {
            return this[c] = function() {
                ...
                return this._log.push("" + c + "(" + function() {
                    ...
                    h = [];
                    d = 0;
                    for (b = arguments.length; d < b; d++) a = arguments[d], h.push(a.toString());
                    return h
        ...
        e.prototype.getImageData = function() {
            ...
            this._log.push("getImageData(" + function() {
                ...
                b = [];
                a = 0;
                for (d = arguments.length; a < d; a++) c = arguments[a], b.push(c.toString());
                return b
            }.apply(this, arguments).join(",") + ")");
            return {
                width: 0,
...
(function() {
    ...
    Epoch.isArray = null != (g = Array.isArray) ? g : e("Array");
    Epoch.isObject = e("Object");
    ...
    Epoch.Util.formatSI = function(c, a, d) {
        ...
        null == d && (d = !1);
        if (1E3 > c) {
            if ((c | 0) !== c || d) c = c.toFixed(a);
            return c
        }
        f = "KMGTPEZY".split("");
        for (h in f)
            if (k = f[h], b = Math.pow(10, 3 * ((h | 0) + 1)), c >= b && c < Math.pow(10,
                    3 * ((h | 0) + 2))) {
                c /= b;
                if (0 !== c % 1 || d) c = c.toFixed(a);
                return "" + c + " " + k
            }
    };
    Epoch.Util.formatBytes = function(c, a, d) {
        ...
        f = "KB MB GB TB PB EB ZB YB".split(" ");
        for (h in f)
            if (k = f[h], b = Math.pow(1024, (h | 0) + 1), c >= b && c < Math.pow(1024, (h | 0) + 2)) {
                c /= b;
                if (0 !== c % 1 || d) c = c.toFixed(a);
                return "" + c + " " + k
            }
...
(function() {
    var e = {}.hasOwnProperty,
        g = function(c, a) {
            ...
            for (var b in a) e.call(a, b) && (c[b] = a[b]);
    ...
    Epoch.Events = function() {
        ...
        c.prototype.onAll = function(a) {
            ...
            if (Epoch.isObject(a)) {
                h = [];
                for (b in a) d = a[b], h.push(this.on(b, d));
                return h
            }
        };
        c.prototype.off =
        ...
        c.prototype.offAll = function(a) {
            ...
            if (Epoch.isArray(a)) {
                k = [];
                d = 0;
                for (h = a.length; d < h; d++) b = a[d], k.push(this.off(b));
                return k
            }
            if (Epoch.isObject(a)) {
                h = [];
                for (b in a) d = a[b], h.push(this.off(b, d));
                return h
            }
        };
        c.prototype.trigger = function(a) {
            ...
            if (null != this._events[a]) {
                d = function() {
                    ...
                    q = [];
                    k = a = 1;
                    for (f = arguments.length; 1 <= f ? a < f : a > f; k = 1 <= f ? ++a : --a) q.push(arguments[k]);
                    return q
                }.apply(this, arguments);
                c = this._events[a];
                m = [];
                f = 0;
                for (q = c.length; f < q; f++) b = c[f], h = null, Epoch.isString(b) ? h = this[b] : Epoch.isFunction(b) && (h = b), null == h && Epoch.exception("Callback for event '" + a + "' is not a function or reference to a method."), m.push(h.apply(this, d));
                return m
            }
        };
        return c
    ...
    Epoch.Chart.Base = function(c) {
        function a(h) {
            ...
            null != this.options.el && (this.el = d3.select(this.options.el));
            this.width = this.options.width;
            this.height = this.options.height;
            null != this.el ? (null == this.width && (this.width = this.el.width()), null == this.height && (this.height = this.el.height())) : (null == this.width && (this.width = d.width), null == this.height && (this.height = d.height));
            this.onAll(b)
        }
        var d, b;
        g(a, c);
        ...
        a.prototype._setManyOptions = function(a, k) {
            ...
            null == k && (k = "");
            b = [];
            for (f in a) q = a[f], Epoch.isObject(q) ? b.push(this._setManyOptions(q, "" + (k + f) + ".")) : b.push(this._setOption(k +
                f, q));
            return b
        };
        ...
        a.prototype.setData = function(a) {
            ...
            k = 1;
            d = 0;
            for (c = a.length; d < c; d++) b = a[d], f = ["layer"], f.push("category" +
    ...
    Epoch.Chart.SVG = function(c) {
        function a(d) {
            ...
            this.svg = null != this.el ? this.el.append("svg") : d3.select(document.createElement("svg"));
            this.svg.attr({
    ...
    Epoch.Chart.Canvas = function(c) {
        function a(d) {
            ...
            null != this.el && this.el.node().appendChild(this.canvas.node());
...
(function() {
    ...
    e = function() {
        ...
        h = function(a) {
            ...
            a = f[2];
            f = f[3];
            b = (null != b ? b : "div").toUpperCase();
            b = document.createElement(b);
            null != a && (b.id = a.substr(1));
        ...
        g.getStyles = function(a, f) {
            ...
            b = [];
            e = 0;
            for (r = m.length; e < r; e++) l = m[e], n = l.nodeName.toLowerCase(), null != l.id && 0 < l.id.length && (n += "#" + l.id), null != l.className && 0 < l.className.length && (n += "." + Epoch.Util.trim(l.className).replace(/\s+/g, ".")), b.push(n);
            b.push("svg");
            e = Epoch.Util.trim(a).split(/\s+/);
            l = 0;
            ...
            r = g.styleList;
            n = 0;
            for (e = r.length; n < e; n++) b = r[n], l[b] = m.style(b);
            g.cache[c] = l;
            g.getContainer().html("");
            return l
        };
...
(function() {
    ...
    Epoch.Chart.Plot = function(c) {
        function a(k) {
            ...
            Epoch.Util.copy(this.options.margins);
            a.__super__.constructor.call(this, this.options = Epoch.Util.defaults(this.options, b));
            this.margins = {};
            u = ["top", "right", "bottom", "left"];
            f = 0;
            for (c = u.length; f < c; f++) k = u[f], this.margins[k] =
                null != this.options.margins && null != this.options.margins[k] ? this.options.margins[k] : this.hasAxis(k) ? d[k] : 6;
        ...
        a.prototype._drawAxes = function() {
            ...
            this.hasAxis("left") && this.g.append("g").attr("class", "y axis left").call(this.leftAxis());
        ...
        a.prototype.marginsChanged = function() {
            ...
            if (null != this.options.margins) {
                ...
                for (a in b) f = b[a], this.margins[a] = null == f ? 6 : f;
        ...
        a.prototype.axesChanged = function() {
            ...
            for (b = c.length; f < b; f++)
                if (a = c[f], null == this.options.margins || null == this.options.margins[a]) this.hasAxis(a) ?
                    this.margins[a] = d[a] : this.margins[a] = 6;
            this.g.transition().duration(750).attr("transform", "translate(" + this.margins.left + ", " + this.margins.top + ")");
            this.g.selectAll(".axis").remove();
            this._axesDrawn = !1;
            return this.draw()
    ...
    Epoch.Chart.Area = function(c) {
        ...
        a.prototype.y = function() {
            ...
            for (f = q.length; k < f; k++)
                for (b in c = q[k], u = c.values, u) c = u[b], null != a[b] && (a[b] += c.y), null == a[b] && (a[b] = c.y);
    ...
    Epoch.Chart.Bar = function(c) {
        ...
        a.prototype.y1 = function(a) {
            ...
            return d3.scale.ordinal().domain(function() {
                ...
                d = [];
                a = 0;
                for (k = b.length; a < k; a++) f = b[a], d.push(f.category);
                return d
            }.call(this)).rangeRoundBands([0, a.rangeBand()], this.options.padding.bar, this.options.outerPadding.bar)
        };
        a.prototype._remapData = function() {
            ...
            t = this.data;
            h = 0;
            for (e = t.length; h < e; h++)
                for (d = t[h], a = "bar " + d.className.replace(/\s*layer\s*/, ""), v = d.values, n = 0, g = v.length; n < g; n++) f = v[n], null == c[s = f.x] && (c[s] = []),
                    c[f.x].push({
                        label: d.category,
                        y: f.y,
                        className: a
        ...
        a.prototype.orientationChanged = function() {
            ...
            b = this.options.tickFormats.left;
            d = this.options.tickFormats.right;
            this.options.tickFormats.left = c;
            this.options.tickFormats.right = a;
            this.options.tickFormats.top = b;
            this.options.tickFormats.bottom =
                d;
            return this.draw()
        };
...
(function() {
    ...
    Epoch.Time.Plot = function(c) {
        function a(k) {
            ...
            "absolute" !== this.el.style("position") && "relative" !== this.el.style("position") && this.el.style("position", "relative");
            this.canvas.style({
                position: "absolute",
                "z-index": "999"
            });
        ...
        a.prototype.setData = function(a) {
            ...
            $.each(a, function(index) {
				console.log(a[index]); 
				h = a[index];
				c = Epoch.Util.copy(h), b = Math.max(0, h.values.length - self.options.historySize), c.values = h.values.slice(b), b = ["layer"], b.push("category" + ((d | 0) + 1)), null != h.label && b.push(Epoch.Util.dasherize(h.label)), c.className = b.join(" "), e.push(self.data.push(c)); 
			});
            return e
        };
        ...
        a.prototype._prepareTimeAxes = function() {
            ...
            this.hasAxis("top") && (a = this.topAxis = this.svg.append("g").attr("class", "x axis top canvas").attr("transform", "translate(" + (this.margins.left - 1) + ", " + this.margins.top + ")"), a.append("path").attr("class", "domain").attr("d",
        ...
        a.prototype._resetInitialTimeTicks = function() {
            ...
            this._ticks = [];
            this._tickTimer = d;
            null != this.bottomAxis && this.bottomAxis.selectAll(".tick").remove();
            null != this.topAxis && this.topAxis.selectAll(".tick").remove();
            h = this.data;
            a = 0;
            for (b = h.length; a < b; a++)
                if (c = h[a], null != c.values && 0 < c.values.length) {
                    b = [this.options.windowSize - 1, c.values.length - 1];
                    a = b[0];
                    for (b = b[1]; 0 <= a && 0 <= b;) this._pushTick(a,
                        c.values[b].time, !1, !0), a -= d, b -= d;
                    break
                }
            return []
        };
        ...
        a.prototype._stopTransition = function() {
            ...
            if (this.inTransition()) {
                d = this.data;
                b = 0;
                for (c = d.length; b < c; b++) a = d[b], a.values.length > this.options.windowSize + 1 && a.values.shift();
                b = [this._ticks[0], this._ticks[this._ticks.length - 1]];
                a = b[0];
                b = b[1];
                null != b && b.enter && (b.enter = !1, b.opacity = 1);
        ...
        a.prototype._shift = function() {
            ...
            a = this._queue.shift();
            d = this.data;
			$.each(d, function(index) { c = d[index], c.values.push(a[index]); });
        ...
        a.prototype._updateTimeAxes = function() {
            ...
            if (this.hasAxis("top") || this.hasAxis("bottom")) {
                ...
                g = [];
                d = 0;
                for (h = e.length; d < h; d++) c = e[d], c.x += b,
                    this.hasAxis("bottom") && c.bottomEl.attr("transform", "translate(" + (c.x + 1) + ",0)"), this.hasAxis("top") && c.topEl.attr("transform", "translate(" + (c.x + 1) + ",0)"), c.enter ? c.opacity += a : c.exit && (c.opacity -= a), c.enter || c.exit ? (this.hasAxis("bottom") && c.bottomEl.style("opacity", c.opacity), this.hasAxis("top") ? g.push(c.topEl.style("opacity", c.opacity)) : g.push(void 0)) : g.push(void 0);
                return g
            }
        };
        ...
        a.prototype.axesChanged = function() {
            ...
            for (c = h.length; b < c; b++)
                if (a = h[b], null == this.options.margins || null == this.options.margins[a]) this.hasAxis(a) ? this.margins[a] = d[a] : this.margins[a] = 6;
            this._sizeCanvas();
            this._buildAxes();
            return this.draw(this.animation.frame * this.animation.delta())
        };
        ...
        a.prototype.marginsChanged = function() {
            ...
            if (null != this.options.margins) {
                ...
                for (a in c) b = c[a], this.margins[a] = null == b ? 6 : b;
                this._sizeCanvas();
                return this.draw(this.animation.frame * this.animation.delta())
            }
        };
    ...
    Epoch.Time.Stack = function(c) {
        ...
        a.prototype.setData = function(c) {
            ...
            for (f = this.data[0].values.length; 0 <= f ? c < f : c > f; b = 0 <= f ? ++c : --c) k = 0, e.push(function() {
                ...
                f = [];
                a = 0;
                for (c = d.length; a < c; a++) h = d[a], h.values[b].y0 = k, f.push(k +=
                    h.values[b].y);
                return f
            }.call(this));
            return e
        ...
        a.prototype.extent = function() {
            ...
            for (g = this.data[0].values.length; 0 <= g ? f < g : f > g; a = 0 <= g ? ++f : --f) {
                b = e = k = 0;
                for (m = this.data.length; 0 <= m ? e < m : e > m; b = 0 <= m ? ++e : --e) k += this.data[b].values[a].y;
                k > c && (c = k)
            }
            return [0, c]
        };
...
(function() {
    ...
    Epoch.Time.Area = function(c) {
        ...
        a.prototype._drawAreas = function(a) {
            ...
            g = g[1];
            p = [];
            for (c = l = n = this.data.length - 1; 0 >= n ? 0 >= l : 0 <= l; c = 0 >= n ? ++l : --l) {
                f = this.data[c];
                this.setStyles(f);
                this.ctx.beginPath();
                ...
                this.ctx.lineTo(this.width * this.pixelRatio + g + a, this.innerHeight());
                this.ctx.closePath();
                p.push(this.ctx.fill())
            }
            return p
        };
    ...
    Epoch.Time.Bar = function(c) {
        ...
        a.prototype.draw = function(c) {
            ...
            for (s = t.length; r < s; r++)
                if (m = t[r], 0 < m.values.length)
                    for (this.setStyles(m.className), e = [this.options.windowSize, m.values.length, this.inTransition()], f = e[0], g = e[1], e = (l = e[2]) ? -1 : 0; --f >= e && 0 <= --g;) b = m.values[g], k = [f * n + c,
                        b.y, b.y0
                    ], b = k[0], h = k[1], k = k[2], l && (b += n), b = [b + 1, p(h + k), n - 2, this.innerHeight() - p(h) + 0.5 * this.pixelRatio], this.ctx.fillRect.apply(this.ctx, b), this.ctx.strokeRect.apply(this.ctx, b);
            return a.__super__.draw.call(this)
        };
        return a
    }(Epoch.Time.Stack)
    ...
    Epoch.Time.Gauge = function(c) {
        ...
        a.prototype.update =
            function(a) {
                ...
                if (!this.animation.active) return this.animation.interval = setInterval(this._animate, 1E3 / this.options.fps), this.animation.active = !0
            };
        a.prototype.push = function(a) {
        ...
        a.prototype.draw = function() {
            ...
            e = g[1];
            g = g[2];
            l = [this.options.tickOffset,
                this.options.tickSize
            ];
            n = l[0];
            p = l[1];
            this.clear();
            l = d3.scale.linear().domain([0, this.options.ticks]).range([-1.125 * Math.PI, Math.PI / 8]);
            this.setStyles(".epoch .gauge .tick");
            this.ctx.beginPath();
            b = s = 0;
            for (t = this.options.ticks; 0 <= t ? s <= t : s >= t; b = 0 <= t ? ++s : --s) b = l(b), b = [Math.cos(b), Math.sin(b)], c = b[0], m = b[1], b = c * (g - n) + d, r = m * (g - n) + e, c = c * (g - n - p) + d, m = m * (g - n - p) + e, this.ctx.moveTo(b, r), this.ctx.lineTo(c, m);
            this.ctx.stroke();
            this.setStyles(".epoch .gauge .arc.outer");
            this.ctx.beginPath();
            this.ctx.arc(d, e, g, -1.125 *
                Math.PI, 0.125 * Math.PI, !1);
            this.ctx.stroke();
            this.setStyles(".epoch .gauge .arc.inner");
            this.ctx.beginPath();
            this.ctx.arc(d, e, g - 10, -1.125 * Math.PI, 0.125 * Math.PI, !1);
            this.ctx.stroke();
            this.drawNeedle();
            return a.__super__.draw.call(this)
        };
        a.prototype.drawNeedle = function() {
            ...
            this.ctx.lineTo(-1 * this.pixelRatio, 19 - c);
            this.ctx.lineTo(1, 19 - c);
            this.ctx.fill();
...
(function() {
    ...
    Epoch.Time.Heatmap = function(c) {
        ...
        a.prototype._getBuckets = function(a) {
            ...
            g = [];
            b = 0;
            for (d = this.options.buckets; 0 <= d ? b < d : b > d; 0 <= d ? ++b : --b) g.push(0);
            e = {
                time: e,
                max: 0,
                buckets: g
            };
            b = (this.options.bucketRange[1] - this.options.bucketRange[0]) / this.options.buckets;
            g = a.histogram;
            for (c in g) a = g[c], d = parseInt((c - this.options.bucketRange[0]) / b), this.options.cutOutliers && (0 > d || d >= this.options.buckets) || (0 > d ? d =
                0 : d >= this.options.buckets && (d = this.options.buckets - 1), e.buckets[d] += parseInt(a));
            c = a = 0;
        ...
        a.prototype._paintEntry = function(a, b) {
            ...
            y = g[0];
            p = g[1];
            null == a && (a = this.data[0].values.length -
                1);
            null == b && (b = this.options.windowSize);
            g = [];
            var x;
            x = [];
            h = 0;
            for (v = this.options.buckets; 0 <= v ? h < v : h > v; 0 <= v ? ++h : --h) x.push(0);
            v = 0;
            t = this.data;
            d = 0;
            for (r = t.length; d < r; d++) {
                s = t[d];
                h = this._getBuckets(s.values[a]);
                w = h.buckets;
                for (c in w) e = w[c], x[c] += e;
                v += h.max;
                e = this.getStyles("." + s.className.split(" ").join(".") + " rect.bucket");
                h.color = e.fill;
                g.push(h)
            }
            s = b * y;
            this.p.clearRect(s, 0, y, this.paintHeight);
            r = this.options.buckets;
            z = [];
            for (c in x) {
                e = x[c];
                d = this._avgLab(g, c);
                w = t = 0;
                for (A = g.length; w < A; w++) h = g[w], t +=
                    h.buckets[c] / e * v;
                if (0 < e || this.options.paintZeroValues) this.p.fillStyle = this._computeColor(e, t, d), this.p.fillRect(s, (r - 1) * p, y - this.options.bucketPadding, p - this.options.bucketPadding);
                z.push(r--)
            }
            return z
        };
        ...
        a.prototype._avgLab = function(a, b) {
            ...
            r = r[3];
            p = 0;
            for (s = a.length; p < s; p++) e = a[p], null != e.buckets[b] &&
                (r += e.buckets[b]);
    ...
    e = function(e) {
        ...
        return e.extend(e.fn, {
            epoch: function(b) {
                ...
                b.el = this.get(0);
                e = Epoch._typeMap[b.type];
                null == e && Epoch.exception("Unknown chart type '" + b.type + "'");
                this.data("epoch-chart", c = d());
                b = new e(b);
                a[c] = b;
                b.draw();
                return b
